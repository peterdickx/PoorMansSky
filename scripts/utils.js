...
/**
 * Draws a triangle between 3 coordinates
 ...
 * @param {number} x2 the x coordinate of the third corner
 * @param {number} y2 the y coordinate of the third corner
 */
export function fillTriangle(x1, y1, x2, y2, x3, y3) {
    context.beginPath();
    context.moveTo(x1, y1);
    context.lineTo(x2, y2);
